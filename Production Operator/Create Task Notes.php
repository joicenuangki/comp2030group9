...
<body>
    ...
    <main>
        ...
        <form action='Note Creation.php' method='post'>
            ...
            <li><ul>
                <li><label for='subject-field'>Subject</label> <input id='subject-field' type='text' name='subject' maxlength="50" required></li>
                <li><label for='note-field'>Note</label> <textarea id='note-field' name='note' maxlength="1000" required></textarea></li>
